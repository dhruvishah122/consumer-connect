...
export function BranchLogin({
  ...
  return (
    (
    <div className={cn(" w-320px h-500px flex flex-col gap-6 mt-24 ", className)} {...props}>
      <Card>
        ...
        <CardContent >
          <form>
            ...
            <div className="flex items-center">
                  <Label className={cn("text-lg")} htmlFor="id" >Branch ID</Label></div>
                  <Input id="number" type="number" placeholder="Enter your Branch ID" required />
                </div>
            <div className="grid gap-2">
                  <div className="flex items-center">
