        ...
        <CardContent >
          <form>
            ...
            <div className="flex items-center">
                  <Label className={cn("text-xl")} htmlFor="name" >Name</Label></div>
                  <Input id="email" type="text" placeholder="Enter your Name" required />
                </div>
                <div className="grid gap-2">
            <div className="flex items-center">
                  <Label className={cn("text-xl")} htmlFor="phone" >Phone Number</Label></div>
                  <Input id="number" type="number" placeholder="Enter your Phone" required />
                </div>
            <div className="grid gap-2">
            <div className="flex items-center">
